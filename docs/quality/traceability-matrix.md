...
| Product status docs sync | #321 open | Manual document review | [Known Limitations](known-limitations.md), [Current State Report](current-state-report.md) | 후속 |
| CI/evidence coverage sync | #322 open | Manual workflow review | [Verification Matrix](verification-matrix.md) | 후속 |
