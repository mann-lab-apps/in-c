...
한 걸음 확장 / 나중에 열릴 작품으로 나뉨 -> 오늘 30초 Daily step을 열어봄 ->
전체 듣기/저장/reaction을 남김 -> 열린 길/다시 알아본 길/내 곡이 된 작품이 쌓임 ->
다음 작품으로 이어짐
```
...
- 오늘 하나만 해도 충분한 Daily listening step.
...
- 첫 화면에서 탐색 목록보다 "오늘 30초만" 할 일이 먼저 보인다.
...
- 알림은 V1에서 local reminder preference와 copy placeholder로 준비하고, 실제 native scheduling은 release GAP으로 둔다.
