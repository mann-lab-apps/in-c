...
- 지원됨: 음가 변경, 삭제와 앞 이벤트 병합, 점음표, 셋잇단음표 기본 입력.
- 부분 지원: 셋잇단음표 해제와 예외 상황 안내.
- 부족함: 타이로 연결된 음표 삭제 정책의 자연스러운 UX.
...
- 저장하기와 PDF 변환은 사용자가 구분할 수 있는 별도 행동으로 제공된다.
...
- 지원됨: MusicXML 가져오기와 내보내기 기본 흐름.
- 부분 지원: 프로젝트 파일 저장과 다시 열기, 배포 빌드에서의 파일 흐름.
- 부족함: PDF 변환 UX와 저장하기/내보내기 메뉴 구조.
