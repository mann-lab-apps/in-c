...
| 필기/annotation | annotation mode에 pen, highlighter, text, stamp, eraser, line, select, layer, crop/cut, staff/grid, metronome, export/download, delete, settings, undo/redo가 한 줄에 있다. | pen/highlighter/eraser/text/stamp(Fine/D.C./D.S./Coda/rit./accel.)/line/arrow/rectangle/crescendo/diminuendo, undo/redo, favorite tool preset, 기본 layer 표시/숨김과 export 포함/제외가 있다. | MobileSheets는 도구가 많지만 초보자에겐 부담스럽다. Clef는 S Pen pressure/palm rejection 실기기 튜닝과 다중 layer 고도화가 남았다. | undo/redo, favorite tool, 기본 shape/stamp, 헤어핀, layer export flag처럼 자주 쓰는 도구만 전면에 둔다. | staff/grid/custom stamp pack까지 v1에 넣는 것. | S Pen QA 후 pressure/palm tuning, 다중 layer/keying, staff/grid 도구를 v1.1 이후로 검토한다. | v1 QA, v1.1 |
...
| Annotation/stylus polish | Clef는 favorite tool preset과 line/arrow/rectangle/stamp는 반영했다. MobileSheets 대비 S Pen 실기기 튜닝, 다중 layer, staff/grid/crescendo/custom stamp pack은 남아 있다. | 중간 | v1.1/Later |
