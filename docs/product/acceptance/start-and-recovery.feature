...
Feature: 시작화면과 복구본으로 작업을 시작하기
  ...
  @scenario-start-recovery-show-start-screen
  ...
  @scenario-start-recovery-open-autosave
  ...
  @scenario-start-recovery-no-autosave
  ...
  @scenario-start-recovery-reopen-recent-musicxml
