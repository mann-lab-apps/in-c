  ...
  build: {
    rollupOptions: {
      input: {
        ...
        clefAndStaff: resolve(__dirname, 'clef-and-staff/index.html'),
        clefAndStaffSupport: resolve(__dirname, 'clef-and-staff/support.html'),
        clefAndStaffPrivacy: resolve(__dirname, 'clef-and-staff/privacy.html'),
        legacyClefAndStaff: resolve(__dirname, 'clef-and-staff.html'),
        legacyClefAndStaffSupport: resolve(__dirname, 'clef-and-staff-support.html'),
        legacyClefAndStaffPrivacy: resolve(__dirname, 'clef-and-staff-privacy.html'),
